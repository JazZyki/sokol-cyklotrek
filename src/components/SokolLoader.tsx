...
export function SokolLoader() {
  return (
    <div className="flex flex-col items-center justify-center space-y-4 w-full max-w-xs mx-auto p-4">
      <div className="loader w-full">
	<div className="center full-height-svg w-full">
		<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 269 134.11" id="svg" className="w-full h-auto">
			...
			<g id="body">
				...
				<path id="ok-2" data-name="ok" d="M224.25 10.61a7 7 0 0 1 0 14" stroke="#4d4d4d" strokeWidth="4" strokeLinecap="round" strokeMiterlimit="10" fill="none"/>
				...
				<path d="M108.5 91.5a5 5 0 1 0 5 5 5 5 0 0 0-5-5z" transform="translate(-7 -3.89)" fill="#333"/><path id="ok-5" data-name="ok" d="M155.5 77.61a14.86 14.86 0 0 0-4.5.69l-51 9.81a4.53 4.53 0 0 0 0 9l51 9.81a14.86 14.86 0 0 0 4.5.69 15 15 0 0 0 0-30z" fill="#b3b3b3" opacity=".5" strokeWidth="3" strokeMiterlimit="10" stroke="#333"/>
			</g>


			<g id="effects">
				<path id="effects10" stroke="#f2f2f2" fill="#998675" strokeWidth="4" strokeLinejoin="round" strokeLinecap="round" d="M104.5 32.61h-63"/>
      ...
      <div className="mt-8 text-center space-y-1">
        <h3 className="text-primary text-3xl font-bold tracking-widest animate-pulse uppercase">
          Sokol Cyklotrek
        </h3>
        <p className="mt-4 text-secondary text-xl uppercase">
          Načítám data, <br />prosím čekejte...
        </p>
      </div>
    </div>
  );
